...
class AppConstants {
  ...
  static const List<String> voiceWakeWordAliases = [
    '이스트',
    '이스트야',
    '이스트요',
    '이스트여',
  ...
  static const double passiveWakeConfidenceThreshold = 0.45;
  static const int passiveWakeMinRecognizedTextLength = 1;
  static const int passiveWakeListeningTimeoutMs = 8000;
  static const int passiveWakePauseSeconds = 3;
  static const bool passiveWakePartialResults = true;
